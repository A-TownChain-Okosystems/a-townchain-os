...
> **P2P Netzwerk-Stack, Kademlia DHT, Bootstrap Node**
...
**Alle Repos:** [→ ECOSYSTEM.md](https://github.com/A-TownChain-Okosystems/a-townchain-os/blob/main/ECOSYSTEM.md)  |  [Repo-Wiki](https://github.com/A-TownChain-Okosystems/atcnet-wiki)
...
**Wird genutzt von:**
- [atc-kernel](https://github.com/A-TownChain-Okosystems/atc-kernel)
