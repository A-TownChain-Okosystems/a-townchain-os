...
| AD-005 | 🟠 MEDIUM | AIP-001 Spezifikation fehlt | Sprint 2.3 |
...
## REGEL 13 — ATCLANG MIGRATIONS-POLICY
...
| 2.5 | Smart Contracts (ATC-8300, ATC-9000, Bridge) | Solidity | ATCLang |
...
|----------|-------|--------|
| ATC-1000 | Proof of History (SHA-3_256 VDF) | ✅ ACCEPTED |
| ATC-1001 | Proof of Work (SHA-256) | ✅ ACCEPTED |
| ATC-1002 | Proof of Stake (Weighted) | ✅ ACCEPTED |
| ATC-1003 | Fork Resolution (Nakamoto+PoH) | ✅ ACCEPTED |
| ATC-1004 | Initial Sync (Batch) | ✅ ACCEPTED |
| ATC-2000 | ECDSA secp256k1 | ✅ ACCEPTED |
| ATC-3000 | Gas Fee EIP-1559 | ✅ ACCEPTED |
| ATC-4000 | AMM x·y=k | ✅ ACCEPTED |
| ATC-8300 | Fungible Token (FFT) | ✅ ACCEPTED |
| ATC-9000 | NFT Standard (Shivamon) | ✅ ACCEPTED |
| ATC-9900 | Cross-Chain Bridge | 🔄 REVIEW |
| ATC-5100 | ATCLang Language Spec | 📝 DRAFT |
| ATC-5101 | ATCLang VM Bytecode | 📝 DRAFT |
| ATC-5102 | ATCLang Standard Library | 📝 DRAFT |
| ATC-5103 | ATCLang Test Framework | 📝 DRAFT |
| KIP-001 | Kernel Interface Protocol | 📝 DRAFT |
| AIP-001 | Agent Interaction Protocol | 📝 DRAFT |
| ATS-001 | Testing Standard | 📝 DRAFT |
